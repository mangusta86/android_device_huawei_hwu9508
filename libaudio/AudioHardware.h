...
{
    class AudioStreamOutHI6421;
    class AudioStreamInHI6421;
...
private:
    ...
    status_t    doRouting();
    AudioStreamInHI6421*   getActiveInput_l();

    class AudioStreamOutHI6421 : public AudioStreamOut {
    public:
                            AudioStreamOutHI6421();
        virtual             ~AudioStreamOutHI6421();
    ...
    class AudioStreamInHI6421 : public AudioStreamIn {
    public:
        enum input_state {
            AUDIO_INPUT_CLOSED,
            AUDIO_INPUT_OPENED,
    ...
    private:
            ...
            AudioStreamOutHI6421*  mOutput;
            SortedVector <AudioStreamInHI6421*>   mInputs;

            msm_snd_endpoint *mSndEndpoints;
            int mNumSndEndpoints;
            int mCurSndDevice;

     friend class AudioStreamInHI6421;
            Mutex       mLock;
...
#endif // ANDROID_AUDIO_HARDWARE_HI6421_H
